...
const Navbar = () => {
    ...
    return (
        <section>
            <nav ref={menuRef} className="bg-[#4c4c4c] top-0 py-4 px-6 lg:px-6 xl:px-8 text-white fixed top-0 w-screen z-30">
                ...
                {isMenuOpen && (
                    <div className="lg:hidden mt-2 p-2">
                        <ul className='list-none space-y-2'>
                            <li>
                                <Link className="text-white" href="/" onClick={closeMenuOnClick}>
                                    Enlace 1
                                </Link>
                            </li>
                            <li>
